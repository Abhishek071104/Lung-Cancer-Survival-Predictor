...
with st.sidebar:
    ...
    st.write("This application uses a trained **Random Forest model** to predict lung cancer patient survival based on clinical and demographic data.")
...
with tab1:
    ...
    if st.button("🎯 Predict Survival"):
        ...
        if prediction == 1:
            ...
            st.error(f"⚠️ The patient is **unlikely to survive**.\n\n🧠 Confidence: **{confidence:.2f}%**")
